...
// 左击操作
// void LrcLabel::mousePressEvent(QMouseEvent *event)
// {
// 	if (event->volBtn() == Qt::LeftButton)
// 		offSet = event->globalPos() - frameGeometry().topLeft();
// }
//
//
// void LrcLabel::mouseMoveEvent(QMouseEvent *event)
// {
// 	//移动鼠标到歌词上时，会显示手型
...
void LrcLabel::hi_setFontSize(int size)
{
